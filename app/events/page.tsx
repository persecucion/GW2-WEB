...
export default function EventsPage() {
    ...
    const sampleEvents: Event[] = [
      {
        ...
        time: "18:00 - 21:00",
        description:
          "Participa en nuestro torneo mensual de PvP con premios exclusivos para los ganadores. Todos los niveles son bienvenidos.",
      ...
      },
      {
        ...
        time: "20:00 - 22:00",
        description:
          "Únete a nuestra divertida noche de bingo con premios exclusivos y mucha diversión. Todos los miembros pueden participar.",
      ...
      },
      {
        ...
        time: "19:00 - 20:30",
        description:
          "Únete a nuestro stream donde discutiremos las últimas actualizaciones de Guild Wars 2 y sus implicaciones para nuestra comunidad.",
      ...
      },
      {
        ...
        time: "21:00 - 23:00",
        description:
          "Avancemos juntos en las raids de Guild Wars 2. Ayuda disponible para nuevos jugadores interesados en contenido de raids.",
      ...
      },
      {
        ...
        time: "Todo el día",
        description:
          "Celebraremos el lanzamiento de la próxima expansión con eventos especiales, sorteos y más. No te lo pierdas.",
      ...
      },
      {
        ...
        time: "16:00 - 19:00",
        description:
          "Muestra tus habilidades de decoración en Guild Wars 2. Los mejores hogares serán premiados con recompensas exclusivas.",
        location: "Discord y Guild Wars 2",
        image: "/images/evento.png",
        category: "competition",
        platform: "discord",
  ...
  const getPlatformIcon = (platform: string) => {
    switch (platform) {
      case "discord":
        return <FaDiscord className="text-white bg-blue-600 p-1 rounded-full" />
      case "twitch":
        return <FaTwitch className="text-white bg-purple-600 p-1 rounded-full" />
      case "both":
        return (
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto" data-aos="fade-up">
            ...
            <p className="text-lg text-gray-300 mb-8 max-w-3xl mx-auto">
              Descubre todos los eventos exclusivos que organizamos para nuestra comunidad. ¡Únete y no te pierdas la
              diversión!
            </p>
          </div>
        </div>
              ...
              <div className="md:flex md:items-center md:justify-between">
                <div className="mb-8 md:mb-0 md:max-w-2xl">
                  ...
                  <p className="text-gray-300">
                    Contacta con el equipo de moderación para proponer eventos comunitarios. Estamos buscando
                    constantemente nuevas formas de interactuar con nuestra comunidad.
                  </p>
                </div>
